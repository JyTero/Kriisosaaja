...
public class EatChipsFromStorage : EatFoodFromStorageBase, IFoodItemInteraction
{
  [SerializeField]
    private GameObject chipsFoodPrefab;
    ...
    protected override ConsumableBase GetConsumableScript()
    {
        ...
        return chipsFoodPrefab.GetComponent<ConsumableBase>();
