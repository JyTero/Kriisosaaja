...
public class TakePastaFromStorage : TakeFoodFromStorageBase, IFoodItemInteraction
{
    [SerializeField]
    ...
    protected override GameObject InstantiateConsumablePrefab(SurfaceSlot slot)
    {
        ...
        return Instantiate(pastaPrefab, slot.itemTransform.position, slot.itemTransform.rotation, slot.itemTransform);
