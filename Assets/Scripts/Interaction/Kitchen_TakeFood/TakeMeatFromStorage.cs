...
public class TakeMeatFromStorage : TakeFoodFromStorageBase, IFoodItemInteraction
{
    [SerializeField]
    ...
    protected override GameObject InstantiateConsumablePrefab(SurfaceSlot slot)
    {
        ...
        return Instantiate(meatPrefab, slot.itemTransform.position, slot.itemTransform.rotation, slot.itemTransform);
